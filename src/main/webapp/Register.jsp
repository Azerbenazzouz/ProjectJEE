        ...
        <div class="container py-5">
            <div class="row mb-4 mb-lg-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <p class="fw-bold text-success mb-2">S'inscrire</p>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body text-center d-flex flex-column align-items-center">
                            ...
                            <form method="post" data-bs-theme="light" action="./Register">
                                ...
                                <div class="mb-3"><button class="btn btn-success shadow d-block w-100" type="submit">S'inscrire</button></div>
                            </form>

                            <a class="btn btn-danger" type="button" href="./Login.jsp">
                                Se connecter
                            </a>
                        </div>
                    </div>
